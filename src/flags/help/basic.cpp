...
void showHelp() {
    ...
    cout << "  " << TEXT_LABEL << "(no option)" << RESET << "          Display full system information\n";
    ...
    cout << "  metetch                 Full system information display\n";
    ...
    cout << "  Full Mode         : Complete system information with all details\n";
    cout << "  Minimal Mode (-m) : Essential information in compact format\n\n";
