...
const string repo = "techoraye/metfetch";
const string api = "https://api.github.com/repos/techoraye/metfetch/releases/latest";
const string bin = "https://github.com/techoraye/metfetch/releases/latest/download/metfetch";
